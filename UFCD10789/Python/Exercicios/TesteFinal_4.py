...
O programa deve permitir que o usuário realize as seguintes operações: 
    Cadastrar livros: 
        O programa deve permitir que o usuário adicione novos livros ao catálogo, informando: 
        - Título 
        - Autor
        - Ano de publicação. 
    Procurar por livros: 
        O usuário deve poder procurar por:
        - Título
        - Autor 
        O programa deve exibir as posições onde o livro foi encontrado e mostrar o conteúdo correspondente. 
    Excluir livros: 
        O usuário deve poder excluir um livro a partir da sua posição no catálogo. 
